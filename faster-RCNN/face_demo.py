...
if __name__ == '__main__':
    ...
    if not os.path.exists(args.out_dir):
        os.makedirs(args.out_dir+'/image')
...
#            bboxes_path = os.path.join(args.out_dir+'/txt', im_file[:-4] + '.txt')
#            export_bboxes(im_file, cls_dets, bboxes_path)
        ...
        if vis:
            ...
            # cv2.waitKey(0)
            result_path = os.path.join(args.out_dir+'/image', imglist[i][:-4] + "_det.jpg")
