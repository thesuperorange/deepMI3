...
do
        ...
        python demoKAIST2.py  --net ${NET} --model_name faster_rcnn_KAIST_AVG_${round}.pth --cuda --load_dir models --model_sub_dir $model_sub_dir --image_dir $FILEPATH --output_folder ${model_sub_dir}/KAIST_fasterRCNN_${NET}-AVG_${round}
